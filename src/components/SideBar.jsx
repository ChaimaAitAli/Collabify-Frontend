...
const SideBar = ({ activeTab, setActiveTab }) => {
    ...
    return (
        <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start overflow-hidden h-100" id="sidenav-main">
            <div className="sidenav-header">
                <i className="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
                <Link className="navbar-brand d-flex align-items-center m-0" href="/dashboard" target="_blank">
                    <div className="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <Image src={logo} alt="logo" height={30} width={30} style={{ marginRight: "7px" }} />
                    </div>
                    <span className="font-weight-bold text-lg">Collabify</span>
                </Link>
            </div>
            <div className="collapse navbar-collapse px-4 w-auto overflow-hidden" id="sidenav-collapse-main" style={{ height: "calc(100% - 70px)" }}>
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <div className="nav-link active" onClick={() => setActiveTab('dashboard')}>
                            <div className="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                    ...
                    <li className="nav-item">
                        <div className="nav-link d-flex justify-content-between align-items-center" style={{ cursor: "pointer" }}>
                        ...
                        {projectsOpen && (
                            <div
                                className={`projects-dropdown overflow-hidden ${projectsOpen ? "max-h-64" : "max-h-0"}`}
                                style={{
                            ...
                            >
                                <ul className="list-unstyled ps-4 pt-1 pb-1">
                                            ...
                                            <a
                                                ...
                                                onMouseOut={(e) => {
                                                    if (activeTab !== `project-${project.id}`) {
                                                        ...
                                                        e.currentTarget.style.backgroundColor = "rgba(55, 65, 81, 1)"; // bg-gray-700
                                                    }
                                                }}
                                                onClick={(e) => {
                                                    e.preventDefault();
                                    ...
                                    <li>
                                        ...
                                        >
                                            <div className="d-flex align-items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#774dd3" className="bi bi-plus-circle" viewBox="0 0 16 16" style={{ marginRight: "8px" }}>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" onClick={() => setActiveTab('reports')} href="#">
                            <div className="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                                <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1">
                                    <title>reports</title>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" onClick={() => setActiveTab('chat')} href="#">
                            <div className="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                                <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1">
                                    <title>chat</title>
                                    <g id="chat" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                        <g id="chat-dots" transform="translate(9.000000, 15.000000)">
                                            <path className="color-foreground" d="M0,1.5 L0,16.5 C0,17.32845 0.67158,18 1.5,18 L3.793,18 L6.4395,20.6465 C6.63475,20.84175 6.95133,20.84175 7.1465,20.6465 L9.793,18 L15.793,18 L21.5,18 C22.32845,18 23,17.32845 23,16.5 L23,1.5 C23,0.67158 22.32845,0 21.5,0 L1.5,0 C0.67158,0 0,0.67158 0,1.5 Z" id="Path" fillRule="nonzero" fill="#FFFFFF"></path>
                                            <path className="color-background" d="M5.5,9 C4.67158,9 4,8.32845 4,7.5 C4,6.67158 4.67158,6 5.5,6 C6.32845,6 7,6.67158 7,7.5 C7,8.32845 6.32845,9 5.5,9 Z M11.5,9 C10.6716,9 10,8.32845 10,7.5 C10,6.67158 10.6716,6 11.5,6 C12.32845,6 13,6.67158 13,7.5 C13,8.32845 12.32845,9 11.5,9 Z M17.5,9 C16.6716,9 16,8.32845 16,7.5 C16,6.67158 16.6716,6 17.5,6 C18.32845,6 19,6.67158 19,7.5 C19,8.32845 18.32845,9 17.5,9 Z" id="Shape" fill="#ccd5ae"></path>
                                        </g>
                                    </g>
                                </svg>
                            </div>
                    ...
                    <li className="nav-item border-start my-0 pt-2">
                        <Link className="nav-link position-relative ms-0 ps-2 py-2" href="/profile">
                            <span className="nav-link-text ms-1">Profile</span>
                        </Link>
                    </li>
                    <li className="nav-item border-start my-0 pt-2">
                        <Link className="nav-link position-relative ms-0 ps-2 py-2" href="/Login">
                            <span className="nav-link-text ms-1">Sign In</span>
                        </Link>
                    </li>
                    <li className="nav-item border-start my-0 pt-2">
                        <Link className="nav-link position-relative ms-0 ps-2 py-2" href="/register">
