...
export default function Dashboard() {
    ...
    const projects = [
        {
            ...
            description: "Comprehensive redesign of the company website focusing on improved UX and mobile responsiveness."
        },
        {
            id: 2,
            name: "Mobile App",
            description: "Development of a cross-platform mobile application for our core services."
        },
        {
            id: 3,
            name: "Marketing Campaign",
            description: "Q2 marketing campaign focusing on social media engagement and brand awareness."
        }
    ];
    ...
    const renderTab = () => {
        ...
        switch (activeTab) {
            ...
            case 'projects':
                return <div className="container-fluid py-4">All Projects Overview</div>;
            case 'reports':
                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <button
                                                ...
                                                style={{ backgroundColor: "#774dd3", borderColor: "#774dd3" }}
