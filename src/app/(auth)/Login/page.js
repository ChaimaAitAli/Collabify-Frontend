                            ...
                            <div className="col-xl-4 col-md-6 col-12 d-flex flex-column mx-auto">
                                <div className="card card-plain mt-7">
                                    <div className="card-header pb-0 text-left bg-transparent">
                                        <h3 className="font-weight-black text-dark display-6">Welcome back</h3>
                                            ...
                                            <div className="d-flex align-items-center">
                                                <div className="form-check form-check-info text-left mb-0">
                                                    <input
                                                        ...
                                                        onChange={handleChange}
                                                    />
                                                    <label className="font-weight-normal text-dark mb-0" htmlFor="rememberMe">
                                                        Remember for 14 days
                                                    </label>
                                                </div>
                                                <Link href="/forgot-password" className="text-xs font-weight-bold ms-auto">
                                                    Forgot password
                                                </Link>
                                            </div>
                                    ...
                                    <div className="card-footer text-center pt-0 px-lg-2 px-1">
                                        <p className="mb-4 text-xs mx-auto">
                                            ...
                                            <Link href="/signup" className="text-dark font-weight-bold ms-1">
                                                Sign up
                                            </Link>
                                        </p>
                                    </div>
                                ...
                                <div className="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                                    ...
                                    >
                                        <div className="  mt-10 p-4 text-start max-width-700 position-absolute m-8">
                                            <h1 className=" mt-3 text-white font-weight-bolder">Join our global community of collaborators.</h1>
                                            <p className="text-white font-weight-bold text-lg mt-2 mb-4">Where Teams Connect, Projects Succeed.</p>
